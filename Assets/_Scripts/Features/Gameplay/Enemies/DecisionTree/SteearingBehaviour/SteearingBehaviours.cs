...
public class SteearingBehaviours : MonoBehaviour
{
    ...
    public static Vector3 CalculateFuturePosition(Transform self, Transform target, Rigidbody targetRB, float maxPredictionTime)
    {
